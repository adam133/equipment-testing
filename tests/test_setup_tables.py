...
class TestSetupAllTables:
    ...
    def test_setup_all_tables_success(self, mock_setup_table, mock_get_table_manager):
        ...
        assert result == 0
        # Verify setup_table was called for each table
    ...
    def test_setup_all_tables_partial_failure(
        self, mock_setup_table, mock_get_table_manager
    ):
